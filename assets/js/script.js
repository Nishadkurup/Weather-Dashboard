...
let modUserInput = "";
let searches = [];
let apiID = '3ee6de7b8fdeda946857956b40bd39af';
...
function fetchGeoCode() {
    ...
    fetch('https://api.openweathermap.org/geo/1.0/direct?q=' + modUserInput + '&limit=1&appid=3ee6de7b8fdeda946857956b40bd39af', {
...
function fetchWeatherInfo(lat, lon, name) {
    ...
    fetch('https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + lon + '&units=imperial&exclude=minutely,hourly,alerts&appid=3ee6de7b8fdeda946857956b40bd39af', {
        method: 'GET', //GET is the default.
        credentials: 'same-origin', // include, *same-origin, omit
        redirect: 'follow', // manual, *follow, error
    })
